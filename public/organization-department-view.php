            ...
            <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 1rem;">
                ...
                <?php if ($canEdit): ?>
                    <div style="display: flex; gap: 0.5rem;">
                        <a href="/organization-department-form.php?id=<?php echo $department->getId(); ?>" class="btn btn-primary">
                            Edit Department
                        </a>
                    </div>
                <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div style="font-weight: 500;">
                            <?php if ($parentDepartment): ?>
                                <a href="/organization-department-view.php?id=<?php echo $parentDepartment->getId(); ?>" class="link">
