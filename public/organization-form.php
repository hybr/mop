...
if (isset($_GET['id'])) {
    ...
    if (!$organization) {
        header('Location: /organizations.php?error=' . urlencode('Organization not found or access denied'));
        exit;
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        header('Location: /organizations.php?success=' . urlencode($successMsg));
        exit;
...
<div class="py-4">
    <div style="max-width: 800px; margin: 0 auto;">
        <div style="margin-bottom: 2rem;">
            <a href="/organizations.php" class="link">← Back to Organizations</a>
        </div>
