...
if (isset($_GET['id'])) {
    ...
    if (!$department) {
        header('Location: /organization-departments.php?error=' . urlencode('Department not found'));
        exit;
    }

    // Check if user can edit (Super Admin only)
    if (!$deptRepo->canEdit($user->getEmail())) {
        header('Location: /organization-departments.php?error=' . urlencode('Only Super Admin can edit departments'));
        exit;
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        header('Location: /organization-departments.php?success=' . urlencode($successMsg));
        exit;
...
<div class="py-4">
    <div style="max-width: 800px; margin: 0 auto;">
        <div style="margin-bottom: 2rem;">
            <a href="/organization-departments.php" class="link">← Back to Departments</a>
        </div>
        ...
        <div class="card">
            ...
            <form method="POST" action="">
                ...
                <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                    <a href="/organization-departments.php" class="btn btn-secondary">Cancel</a>
