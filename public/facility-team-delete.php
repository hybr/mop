...
try {
    ...
    if ($isPermanent) {
        ...
        if ($success) {
            header('Location: /organizations/facilities?success=Facility team permanently deleted');
        } else {
        ...
        if ($success) {
            header('Location: /organizations/facilities?success=Facility team moved to trash');
        } else {
