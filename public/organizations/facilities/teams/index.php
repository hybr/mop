...
<div class="py-4">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        ...
        <a href="/organizations/facilities/teams/form/" class="btn btn-primary">+ New Facility Team</a>
    </div>
    ...
    <div class="card" style="margin-bottom: 2rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
            <a href="/organizations/facilities/teams/branches/" class="btn btn-secondary" style="padding: 1rem; text-align: center;">
                Branches
            </a>
            <a href="/organizations/facilities/teams" class="btn btn-primary" style="padding: 1rem; text-align: center;">
                Teams
            </a>
    ...
    <div class="card">
        ...
        <?php if (empty($facilityTeams)): ?>
            ...
            <div style="text-align: center; padding: 3rem 1rem;">
                ...
                <a href="/organizations/facilities/teams/form/" class="btn btn-primary">Create Your First Facility Team</a>
            </div>
        <?php else: ?>
            <!-- Desktop Table View -->
                    ...
                    <tbody>
                        <?php foreach ($facilityTeams as $dept): ?>
                            <tr style="border-bottom: 1px solid var(--border-color);" data-status="<?php echo $dept->getIsActive() ? 'active' : 'inactive'; ?>">
                                ...
                                <td style="padding: 1rem; white-space: nowrap;">
                                    <a href="/organizations/facilities/teams/form/?id=<?php echo $dept->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">Edit</a>
                                    <?php if ($facilityTeamRepo->isSuperAdmin($user->getEmail())): ?>
                                        <a href="/organizations/facilities/teams/delete/?id=<?php echo $dept->getId(); ?>" class="btn btn-danger" style="padding: 0.5rem 1rem;" onclick="return confirm('Are you sure you want to delete this facility team?');">Delete</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                ...
                <?php foreach ($facilityTeams as $dept): ?>
                    <div class="card" style="margin-bottom: 1rem; padding: 1rem;" data-status="<?php echo $dept->getIsActive() ? 'active' : 'inactive'; ?>">
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="/organizations/facilities/teams/form/?id=<?php echo $dept->getId(); ?>" class="btn btn-secondary" style="flex: 1; text-align: center;">Edit</a>
                            <?php if ($facilityTeamRepo->isSuperAdmin($user->getEmail())): ?>
                                <a href="/organizations/facilities/teams/delete/?id=<?php echo $dept->getId(); ?>" class="btn btn-danger" style="flex: 1; text-align: center;" onclick="return confirm('Are you sure you want to delete this facility team?');">Delete</a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
                    ...
                    <tbody>
                        <?php foreach ($deletedTeams as $dept): ?>
                            <tr style="border-bottom: 1px solid var(--border-color); opacity: 0.6;">
                                ...
                                <td style="padding: 1rem; white-space: nowrap;">
                                    <a href="/organizations/facilities/teams/restore/?id=<?php echo $dept->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">Restore</a>
                                    <a href="/organizations/facilities/teams/delete/?id=<?php echo $dept->getId(); ?>&permanent=1" class="btn btn-danger" style="padding: 0.5rem 1rem;" onclick="return confirm('Permanently delete this facility team? This cannot be undone!');">Delete Forever</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
