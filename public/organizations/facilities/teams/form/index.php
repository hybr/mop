...
if (isset($_GET['id'])) {
    ...
    if (!$team) {
        header('Location: /organizations/facilities/teams?error=Team not found');
        exit;
    }
}
...
<div class="py-4">
    ...
    <div style="margin-bottom: 1rem;">
        ...
        <a href="/organizations/facilities/teams" class="link">Facility Teams</a>
        <span style="color: var(--text-light);"> / </span>
    ...
    <div class="card">
        <form method="POST" action="" style="max-width: 800px;">
            ...
            <div style="display: flex; gap: 1rem; flex-wrap: wrap; padding-top: 1.5rem; border-top: 2px solid var(--border-color);">
                ...
                <a href="/organizations/facilities/teams" class="btn btn-secondary" style="padding: 0.75rem 2rem; text-decoration: none;">
                    Cancel
                </a>
                <?php if ($isEdit): ?>
                    <a href="/organizations/facilities/teams/form/" class="btn btn-secondary" style="padding: 0.75rem 2rem; text-decoration: none; margin-left: auto;">
                        + Create New Instead
                    </a>
                <?php endif; ?>
            </div>
