...
if (isset($_GET['id'])) {
    ...
    if (!$branch) {
        header('Location: /organizations/facilities/branches/?error=Branch not found');
        exit;
    }
}
    ...
    try {
        ...
        if (empty($errors)) {
            if ($isEdit) {
                ...
                header('Location: /organizations/facilities/branches/?success=' . urlencode($successMsg));
                exit;
            } else {
                // Create new
...
<div class="py-4">
    ...
    <div style="margin-bottom: 1rem;">
        ...
        <a href="/organizations/facilities/branches/" class="link">Branches</a>
        <span style="color: var(--text-light);"> / </span>
    ...
    <div class="card">
        <form method="POST" action="" style="max-width: 800px;">
            ...
            <div style="display: flex; gap: 1rem; flex-wrap: wrap; padding-top: 1.5rem; border-top: 2px solid var(--border-color);">
                ...
                <a href="/organizations/facilities/branches/" class="btn btn-secondary" style="padding: 0.75rem 2rem; text-decoration: none;">
                    Cancel
                </a>
                <?php if ($isEdit): ?>
                    <a href="/organizations/facilities/branches/form/" class="btn btn-secondary" style="padding: 0.75rem 2rem; text-decoration: none; margin-left: auto;">
                        + Create New Instead
                    </a>
                <?php endif; ?>
            </div>
