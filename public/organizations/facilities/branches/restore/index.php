...
if (!isset($_GET["id"])) { header("Location: /organizations/facilities/branches/?error=No branch specified"); exit; }
$id = $_GET["id"];
try {
    ...
    header("Location: /organizations/facilities/branches/?success=Branch restored");
} catch (Exception $e) {
    header("Location: /organizations/facilities/branches/?error=" . urlencode($e->getMessage()));
}
exit;
