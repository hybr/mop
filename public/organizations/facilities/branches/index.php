...
<div class="py-4">
    ...
    <div style="margin-bottom: 1rem;">
        ...
        <a href="/organizations/facilities/teams/teams/" class="link">Facilities</a>
        <span style="color: var(--text-light);"> / </span>
        <span>Branches</span>
    </div>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        ...
        <a href="/organizations/facilities/branches/form/" class="btn btn-primary">+ New Branch</a>
    </div>
    ...
    <div class="card">
        ...
        <?php if (empty($branches)): ?>
            ...
            <div style="text-align: center; padding: 3rem 1rem;">
                ...
                <?php else: ?>
                    <a href="/organizations/facilities/branches/form/" class="btn btn-primary">Create Your First Branch</a>
                <?php endif; ?>
            </div>
        <?php else: ?>
            <!-- Desktop Table View -->
                    ...
                    <tbody>
                        <?php foreach ($branches as $branch): ?>
                            <tr style="border-bottom: 1px solid var(--border-color);"
                                ...
                                <td style="padding: 1rem; white-space: nowrap;">
                                    <a href="/organizations/facilities/branches/form/?id=<?php echo $branch->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">Edit</a>
                                    <?php if ($branchRepo->isSuperAdmin($user->getEmail())): ?>
                                        <a href="/organizations/facilities/branches/delete/?id=<?php echo $branch->getId(); ?>" class="btn btn-danger" style="padding: 0.5rem 1rem;" onclick="return confirm('Are you sure you want to delete this branch?');">Delete</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                ...
                <?php foreach ($branches as $branch): ?>
                    <div class="card" style="margin-bottom: 1rem; padding: 1rem;"
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="/organizations/facilities/branches/form/?id=<?php echo $branch->getId(); ?>" class="btn btn-secondary" style="flex: 1; text-align: center;">Edit</a>
                            <?php if ($branchRepo->isSuperAdmin($user->getEmail())): ?>
                                <a href="/organizations/facilities/branches/delete/?id=<?php echo $branch->getId(); ?>" class="btn btn-danger" style="flex: 1; text-align: center;" onclick="return confirm('Are you sure?');">Delete</a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
                    ...
                    <tbody>
                        <?php foreach ($deletedBranches as $branch): ?>
                            <tr style="border-bottom: 1px solid var(--border-color); opacity: 0.6;">
                                ...
                                <td style="padding: 1rem; white-space: nowrap;">
                                    <a href="/organizations/facilities/branches/restore/?id=<?php echo $branch->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">Restore</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
