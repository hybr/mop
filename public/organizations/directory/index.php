    ...
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <?php if (empty($organizations)): ?>
            ...
            <div class="card" style="text-align: center; padding: 4rem 2rem;">
                ...
                <?php else: ?>
                    <a href="/organizations/form/" class="btn btn-primary">Create First Organization</a>
                <?php endif; ?>
            </div>
        <?php else: ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem;">
                <?php foreach ($organizations as $org): ?>
                    <div class="card" style="display: flex; flex-direction: column; transition: transform 0.2s, box-shadow 0.2s; cursor: pointer;" onclick="window.location.href='/organizations/view/?id=<?php echo $org['id']; ?>'">
                        <!-- Logo -->
                        <?php if ($org['logo_url']): ?>
