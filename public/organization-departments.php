...
<div class="py-4">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="/organization-department-form.php" class="btn btn-primary">+ New Department</a>
    </div>
    ...
    <div class="card">
        ...
        <?php if (empty($departments)): ?>
            <div style="text-align: center; padding: 3rem 1rem;">
                ...
                <a href="/organization-department-form.php" class="btn btn-primary">Create Your First Department</a>
            </div>
        <?php else: ?>
                        ...
                        <?php foreach ($departments as $dept): ?>
                            <tr style="border-bottom: 1px solid var(--border-color);">
                                ...
                                <td style="padding: 1rem; white-space: nowrap;">
                                    <a href="/organization-department-view.php?id=<?php echo $dept->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">View</a>
                                    <?php if ($isSuperAdmin): ?>
                                        <a href="/organization-department-form.php?id=<?php echo $dept->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">Edit</a>
                                        <a href="/organization-department-delete.php?id=<?php echo $dept->getId(); ?>" class="btn btn-danger" style="padding: 0.5rem 1rem;" onclick="return confirm('Are you sure you want to delete this department?');">Delete</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    ...
                    <tbody>
                        <?php foreach ($deletedDepts as $dept): ?>
                            <tr style="border-bottom: 1px solid var(--border-color); opacity: 0.6;">
                                ...
                                <td style="padding: 1rem; white-space: nowrap;">
                                    <a href="/organization-department-restore.php?id=<?php echo $dept->getId(); ?>" class="btn btn-secondary" style="padding: 0.5rem 1rem; margin-right: 0.5rem;">Restore</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
