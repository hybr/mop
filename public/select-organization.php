...
if (empty($organizations)) {
    header('Location: /organization-form.php?message=' . urlencode('Please create an organization first'));
    exit;
}
...
<div class="py-4">
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <div style="margin-top: 2rem; text-align: center;">
            <a href="/organization-form.php" class="btn btn-secondary" style="padding: 0.75rem 2rem; text-decoration: none;">
