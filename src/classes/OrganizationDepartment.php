...
class OrganizationDepartment {
    private $id;
    private $name;                   // Department name (e.g., "Human Resources")
    private $code;                   // Unique code (e.g., "HR", "FINANCE")
    ...
    public function setCode($code) {
        ...
        if (!empty($code)) {
            ...
            if (!preg_match('/^[A-Z0-9_]+$/', $code)) {
                throw new \Exception("Department code can only contain uppercase letters, numbers, and underscores");
            }
            if (strlen($code) < 2 || strlen($code) > 20) {
                throw new \Exception("Department code must be between 2 and 20 characters");
            }
        }
        $this->code = $code;
    }
    ...
    public function validate() {
        ...
        if (empty($this->code)) {
            ...
            $errors[] = "Department code can only contain uppercase letters, numbers, and underscores";
